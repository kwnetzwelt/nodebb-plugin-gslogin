(function(module) {
  ...
  var User = module.parent.require('./user'),
      ...
      name: 'contentblvd',
      // Something unique to your OAuth provider in lowercase, like "github", or "nodebb"
  ...
  CB.getStrategy = function(strategies, callback) {
    passport.use(new BearerStrategy({}, function(token, done) {
      ...
      var externalId = cookie.unsign(token_decoded, 'ruttabegga');
  ...
  CB.deleteUserData = function(uid, callback) {
    async.waterfall([
    async.apply(User.getUserField, uid, constants.name + 'Id'), function(CBIdToDelete, next) {
